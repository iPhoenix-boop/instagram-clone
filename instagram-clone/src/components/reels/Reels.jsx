...
// import { FaHeart, FaRegHeart, FaComment, FaPaperPlane, FaMusic, FaPause, FaPlay, FaEllipsisH } from 'react-icons/fa';
...
//     // Working video URLs that are accessible
...
//         // Replace video URLs with working ones
//         const reelsWithWorkingVideos = data.reels.map((reel, index) => ({
//             ...reel,
//             video_url: workingVideoUrls[index % workingVideoUrls.length]
//         }));
...
//         // Try to use a fallback video URL
//         const fallbackUrl = 'https://commondatastorage.googleapis.com/gtv-videos-bucket/sample/ForBiggerJoyrides.mp4';
//         setReels(prev => prev.map((reel, idx) =>
//             idx === index ? { ...reel, video_url: fallbackUrl } : reel
//         ));
//     };
...
//                                 onLoadStart={() => console.log(`Video ${reel.id} loading started`)}
//                             />

//                             {/* Video Fallback for unsupported formats or loading errors */}
//                             {!videoLoaded[reel.id] && (
//                                 <div style={{
//                                     position: 'absolute',
//                                     top: '50%',
...
//                                 <span>Original Sound - {reel.user.username}</span>
//                             </div>
//                         </div>
