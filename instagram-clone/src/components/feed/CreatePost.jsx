    ...
    const handleSubmit = async (e) => {
        ...
        setTimeout(() => {
            const newPost = {
                ...
                image_url: imagePreview || 'https://images.unsplash.com/photo-1579546929662-711aa81148cf?w=500&h=500&fit=crop',
                    ...
                    <div style={{
                        ...
                        <div className="d-flex align-items-center p-3 border-bottom">
                            ...
                            <div>
                                ...
                                <div style={{ fontSize: '13px', color: '#0095f6' }}>
                                    Public ▼
                                </div>
                            </div>
                        </div>
                        ...
                        <form onSubmit={handleSubmit}>
                            ...
                            <div className="p-3 border-top">
                                ...
                                <div className="d-flex gap-3">
                                    ...
                                    >
                                        <FaMapMarkerAlt style={{ color: '#f5533d' }} />
                                        Location
                                    </button>
                                </div>
                            </div>
                            ...
                            <div className="p-3 border-top">
                                <button
                                    ...
                                    style={{
                                        ...
                                        padding: '12px',
                                        borderRadius: '8px',
                                        opacity: (loading || (!content.trim() && !imagePreview)) ? 0.7 : 1,
                                        transition: 'all 0.3s ease'
                                    }}
                                >
                                    {loading ? (
